...
USAGE = "Usage: scons <target> [profile=<debug|release|fast>] [robot=TARGET_<ROBOT_TYPE>] [profiling=<true|false>] [use-solutions=[true|false]]\n\
    \"<target>\" is one of:\n\
...
def parse_args():
    ...
    args["USE_SOLUTIONS"] = ARGUMENTS.get("use-solutions", "false") == "true"
